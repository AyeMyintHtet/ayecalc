...
export const converterDefinitions: ConverterDefinition[] = [
  {
    ...
    searchTerms: [
      ...
      "convert PX to REM",
      "pixel REM converter",
      "REM conversion calculator",
      "PX to root EM converter",
    ],
    fromName: "pixels",
    toName: "root ems",
    fromSymbol: "px",
  ...
  },
  {
    ...
    searchTerms: [
      ...
      "convert PX to EM",
      "pixel EM converter",
      "EM conversion calculator",
      "PX to relative EM converter",
    ],
    fromName: "pixels",
    toName: "ems",
    fromSymbol: "px",
  ...
  },
  {
    ...
    searchTerms: [
      ...
      "convert REM to EM",
      "CSS relative unit converter",
      "root EM to EM converter",
      "REM versus EM calculator",
      "REM EM conversion",
      "font relative unit calculator",
    ],
    fromName: "root ems",
    toName: "ems",
    fromSymbol: "rem",
  ...
  },
  {
    ...
    searchTerms: [
      ...
      "pound kilogram calculator",
      "convert pounds to kilograms",
      "weight converter LB KG",
      "body weight converter pounds to kg",
      "imperial to metric weight converter",
    ],
    fromName: "pounds",
    toName: "kilograms",
    fromSymbol: "lb",
  ...
  },
  {
    ...
    searchTerms: [
      ...
      "body weight converter kg to pounds",
      "metric to imperial weight converter",
    ],
    fromName: "kilograms",
    toName: "pounds",
    fromSymbol: "kg",
  ...
  },
  {
    ...
    searchTerms: [
      ...
      "CM inch calculator",
      "length converter centimeters inches",
    ],
  ...
  },
  {
    ...
    searchTerms: [
      ...
      "imperial to metric length converter",
      "inch CM calculator",
      "length converter inches centimeters",
    ],
    fromName: "inches",
    toName: "centimeters",
    fromSymbol: "in",
